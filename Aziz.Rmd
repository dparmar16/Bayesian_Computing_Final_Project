...
```
# Notes
Remove data prior to 2007? 2013?
...
```{r}
mercedes_C<- data[(data$Car.Make == "Mercedes C Class"),]
mercedes <-data[(data$Car.Make == "Mercedes")& (data$model == " C Class"),]
str(mercedes)

print(table(mercedes$year))
print(mean(mercedes$price))
print(sd(mercedes$price))
boxplot(mercedes$price)


```
```{r}
str(mercedes_C)
print(table(mercedes_C$year))
print(mean(mercedes_C$price))
print(sd(mercedes_C$price))
boxplot(mercedes_C$price)
```
