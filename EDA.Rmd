...
price_jags <- jags.model(textConnection(price_model), data = list(y = data_df$Price_Range, x = data_df$tax))
update(price_jags, 10000)
price_sim <- coda.samples(price_jags, c("b0", "b1"), 100000)
